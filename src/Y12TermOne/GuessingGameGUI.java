...
public class GuessingGameGUI extends Frame implements ActionListener {
   ...
   public GuessingGameGUI () {
      ...
      lblCount = new Label("Guess");  // construct the Label component
   ...
   public static void main(String[] args) {
      // Invoke the constructor to setup the GUI, by allocating an instance
	   GuessingGameGUI app = new GuessingGameGUI();
